...
@defproc[(make-posn [x ei-tyyppivaatimusta][y ei-tyyppivaatimusta]) posn?]{
 Luo posn-tietueen, jonka kenttiin tallennetaan @racket[x] ja @racket[y].
...
@defproc[(posn? [x ei-tyyppivaatimusta]) totuusarvo]{
 Tutkii, onko @racket[x] tietue, joka on tehty käyttämällä @racket[make-posn]:ia.
